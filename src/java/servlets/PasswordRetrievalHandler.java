...
public class PasswordRetrievalHandler extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (mailStatus == true) {
                serverResponse = "A password reset email has been sent to the provided email, please follow the instructions to reset your password!";

            } else {
                serverResponse = "The provided email is not registered to an account!";

            }

            response.sendRedirect("./PasswordRetrieval.jsp?response=" + serverResponse);
